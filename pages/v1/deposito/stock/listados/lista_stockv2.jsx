                        ...
                        <Col span={24}>
                          <Input
                            ...
                            prefix={
                              <>
                                <Switch
                                  checked={codigoSearch}
                                  onChange={(c) => {
                                    setCodigoSearch(!codigoSearch);
                                  }}
                                  checkedChildren="Código"
                                  unCheckedChildren="Grupo"
                                />
                              </>
                            }
                            onChange={(e) => {
                            ...
                            addonAfter={
                              <>
                                <Button
                                  type="text"
                                  onClick={(e) => {
                                    onQuickSearchClick(e.target.value);
                                  }}
                                >
                                  <SearchOutlined />
                                </Button>
                            ...
                            <Form.Item label="" name={"tipo_filtro"}>
                              <Select
                                ...
                                options={[
                                  ...
                                  {
                                    label: "Grupo Contenga a",
                                    value: "grupo_contenga_a",
                                  },
                                  {
                                    label: "Codigo Contenga a",
                                    value: "codigo_contenga_a",
                                  },
                                  //{label: 'Codigo Igual a ', value: 'codigo_igual_a'},
                                  {
                                    label: "Precio - Mayor a",
                                    value: "precio_mayor_a",
                                  },
                                  {
                                    label: "Precio - Menor a",
                                    value: "precio_menor_a",
                                  },
                                  {
                                    label: "Precio - Igual a",
                                    value: "precio_igual_a",
                                  },
                                  {
                                    label: "Cantidad - Igual a",
                                    value: "cantidad_igual_a",
                                  },
                                  {
                                    label: "Cantidad - Mayor a",
                                    value: "cantidad_mayor_a",
                                  },
                                  {
                                    label: "Cantidad - Menor a",
                                    value: "cantidad_menor_a",
                                  },
                      ...
                      <Form form={form1} onFinish={onFinish}>
                        <Row>
                          <Col span={24}>
                            <Form.Item
                              label={"Filtros:"}
                              style={{ backgroundColor: "#D8DFE6" }}
                            >
                              {tags.map((t) =>
                                typeof tipos_filtro_dic[t.tipo] ===
                                  "undefined" ||
                          ...
                          <Col span={6}>
                            <Form.Item label="" name={"orden"}>
                              <Select
                                ...
                                options={[
                                  {
                                    label: "Alfabetico - Ascendiente",
                                    value: "alf_asc",
                                  },
                                  {
                                    label: "Alfabetico - Descendiente",
                                    value: "alf_desc",
                                  },
                                  {
                                  ...
                                  {
                                    label: "Precio - Ascendiente",
                                    value: "precio_asc",
                                  },
                                  {
                                    label: "Cantidad - Ascendiente",
                                    value: "cantidad_asc",
                                  },
                                  {
                                    label: "Cantidad - Descendiente",
                                    value: "cantidad_desc",
                                  },
                                ]}
...
ListaStockV2.PageLayout = globals.esUsuarioDepositoMin()
  ? LayoutVentas
  : MyLayout;
