            ...
            <>
              ...
              {subgrupo != null ? (
                <p style={{ fontSize: ".75em" }}>
                  <i>
                    Subgrupo: {subgrupo.nombre_corto} Multiplicador:{" "}
                    {subgrupo.multiplicador}{" "}
                  </i>
                </p>
              ) : null}
            </>
          ...
          <Form.Item label={"Factura"} name={"factura"}>
            <>
              <FacturaSelect
                reload={updateall}
                callback={(id) => {
                  /*getSubGrupoDetails(id);*/ setValue("factura", id);
                }}
              />
              <br />
              {/* agregar facturas */}
          ...
          <Form.Item label={"Codigos"} name={"codigos"}>
            <>
              {idSubgrupo === -1 ? (
                ...
                <>
                  <Button onClick={onAgregarCodigosBtnClick}>
                    Agregar C&oacure;digos
                  </Button>
