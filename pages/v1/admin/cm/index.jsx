        ...
        <Tabs
          ...
          items={[
                        ...
                        extra={
                          <>
                            <Button
                              size="small"
                              style={buttonStyle}
                              onClick={() => setIngresoPlataOpen(true)}
                            >
                              Nuevo Egreso
                            </Button>
                            <Button
                            ...
                            <Button
                              size="small"
                              style={buttonStyle}
                              onClick={() => setTransferenciaFondoFOpen(true)}
                            >
                              Nueva Transferencia a Fondo Fijo
                            </Button>
                          </>
                        }
                      >
            ...
            },
            {
              ...
              label: (
                <>
                  <OrderedListOutlined /> Listado
                </>
              ),
              children: (
                <>
                  <Card title="Control de Cajas" size="small" extra={<></>}>
                    <Row>
                      <Col span={24}></Col>
                      <Col span={24}></Col>
                    </Row>
                        ...
                        title={(_) => (
                          <>
                            ...
                            <Button
                              size="small"
                              style={buttonStyle}
                              onClick={() => setNuevoFondoOpen(true)}
                            >
                              Nuevo Fondo Fijo
                            </Button>
                          </>
