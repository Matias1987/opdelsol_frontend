...
import GridBifocales from "./GridBifocales";

const GridBifocalesTipos = (props) => {
  ...
  return (
    <>
      ...
      >
        <EditarCantidadCritica idcodigo={recordId} callback={_=>{setModalEditarCriticoOpen(false); onHasToUpdate?.();}} />
      </Modal>
      <Modal
      ...
      >
          <CargaStockIdeal idcodigo={recordId} callback={_=>{setModalEditarIdealOpen(false); onHasToUpdate?.();}} />
      ...
      >
        <EditarStockIndiv idcodigo={recordId} idsucursal={props.idsucursal} callback={_=>{ onHasToUpdate?.(); setModalEditarStockOpen(false);}} />
      </Modal>
      <Modal
...
export default GridBifocalesTipos;
