import { Button, Col, Progress, Row, Input, Flex } from "antd";
...
import ProgressDonutChart from "@/components/charts/donutProgress";
...
const FoodLoader = (props) => {
  ...
  const onSave = (_) => {
    post_method(
      post.insert.establecer_objetivo_sucursal,
      {
            ...
            <Col span={24}>
              <Flex align="center" justify="center">
                <i style={{ color: "darkblue", fontSize: ".9em" }}>
                  Progreso: {data.progreso == 100 ? "100%" : ""}
                </i>
              </Flex>
            </Col>
          </Row>*/}
              ...
              <Flex align="center" justify="center">
                {/*<Progress
                  ...
                  style={{
                    color: "white",
                    fontWeight: "bold",
                    background: `url(${"http://localhost:3000/burger.png"})`,
                    backgroundRepeat: "no-repeat",
                  }}
                />*/}
                <ProgressDonutChart percentage={parseInt(data.progreso)} />
              </Flex>
            </Col>
          </Row>
        </>
