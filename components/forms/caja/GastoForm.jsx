  ...
  return (
    <>
      <Row style={row_style}>
        ...
        <Col span={24}>
          <Select
            value={gasto.idmotivo}
            style={{ width: "100%" }}
            options={options}
            onChange={(value) => {
              onChange(value, "idmotivo");
            }}
          />
        </Col>
      </Row>
      ...
      <Row style={row_style}>
        ...
        <Col span={24}>
          <Input
            ...
            type="number"
            onChange={(e) => {
              onChange(parse_float_string(e.target.value), "monto");
            }}
          />
        </Col>
      </Row>
      <Row style={row_style}>
        ...
        <Col span={24}>
          <Input
            value={gasto.comentarios}
            onClick={(e) => {
              e.target.select();
            }}
            maxLength={49}
            placeholder="Max. 49 carac."
            onChange={(e) => {
              onChange(e.target.value, "comentarios");
            }}
          />
        </Col>
      </Row>
