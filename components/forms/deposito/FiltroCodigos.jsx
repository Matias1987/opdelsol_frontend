...
const FiltroCodigos = (props) => {
  ...
  const categoria_select_callback = (cat, id) => {
      ...
      <Row style={{ padding: ".2em" }}>
        <Col span={23}>
          <Row>
            <Col
              span={24}
              style={{ backgroundColor: "#E5E8E7", padding: "4px" }}
            >
              <CategoriaSelect callback={categoria_select_callback} />
            </Col>
          </Row>
          {hideTags ? (
            <></>
