  ...
  return (
    <>
      {codigo == null ? (
        ...
        <>
          <Row>
            <Col span={24}>Modificar C&oacute;digo</Col>
          </Row>
          <Row>
            <Col span={24}>
              <Input
                style={{
                  ...
                  color: codigo.codigo_orig === codigo.codigo ? "black" : "red",
                }}
                prefix="Código: "
                value={(codigo.codigo || "").toUpperCase()}
                onChange={(e) => {
          ...
          <Row>
            <Col span={24}>
              <Button onClick={onSave} block type="primary">
                Guardar Cambios
              </Button>
            </Col>
          </Row>
