...
import { CloseOutlined, PlusOutlined, ReloadOutlined, UserAddOutlined, UserOutlined, UserSwitchOutlined } from "@ant-design/icons";
...
/*        {dataIndex: 'idcliente', title: '', key: 'acciones', render: (_,{idcliente, bloqueado})=>(
    ...
    return (
        ...
        size="small"
        onOpen={onOpenPopup} 
        openButtonText={ <span style={{fontWeight:"bolder", color:"#e90800", fontSize:"1.1em"}}><UserOutlined /> Seleccione Cliente ...</span> } 
        ...
        footer={null}
        >
            <ClienteFormDistrib callback={(id)=>{
                setReload(!reload)
...
export default SelectClienteMayorista;