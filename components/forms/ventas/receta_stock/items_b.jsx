        ...
        <>
          ...
          <Row className="table-row-light" style={{ padding: ".7em" }}>
            ...
            <Col span={22}>
              <VentasArmazon
                onVisibleChange={(_value) =>
                  onVisibleChange("lejos_armazon_visible", _value)
                }
                tipo="LEJOS_ARMAZON"
                buttonText={<SelectCodeButton />}
                callback={(v) => {
                  on_change("lejos_armazon", v);
                }}
                data={rcitems.lejos_armazon}
              />
            </Col>
          </Row>
          <Row className="table-row-dark" style={{ padding: ".7em" }}>
            ...
            <Col span={22}>
              <VentasTratamiento
                ...
                data={rcitems.lejos_tratamiento}
              />
            </Col>
          </Row>
        </>
        ...
        <>
          ...
          <Row className="table-row-light" style={{ padding: ".7em" }}>
            ...
            <Col span={22}>
              <VentasArmazon
                onVisibleChange={(_value) =>
                  onVisibleChange("cerca_armazon_visible", _value)
                }
                tipo="CERCA_ARMAZON"
                buttonText={<SelectCodeButton />}
                callback={(v) => {
                  on_change("cerca_armazon", v);
                }}
                data={rcitems.cerca_armazon}
              />
            </Col>
          </Row>
          <Row className="table-row-dark" style={{ padding: ".7em" }}>
            ...
            <Col span={22}>
              <VentasTratamiento
                ...
                data={rcitems.cerca_tratamiento}
              />
            </Col>
          </Row>
        </>
