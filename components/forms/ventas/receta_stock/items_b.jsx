...
import RecStockCristalEsfCil from "./cstm/RecStockCristalEsfCil";



const RecetaStockItemsB = (props) => {
    ...
    const tabs_items = [
        {
            ...
            children: 
                ...
                <Row className="table-row-light" style={{padding:".7em"}}>
                    ...
                    <Col span={22}>
                        <RecStockCristalEsfCil onVisibleChange={(_value)=>onVisibleChange("lejos_od_visible",_value)} tipo='LEJOS_OD' buttonText={<SelectCodeButton />} callback={(v)=>{on_change("lejos_od",v)}}/>
                    </Col>
                </Row>
                <Row className="table-row-dark" style={{padding:".7em"}}>
                    <Col style={_style_label} span={2}>OI</Col>
                    <Col span={22}>
                        <RecStockCristalEsfCil onVisibleChange={(_value)=>onVisibleChange("lejos_oi_visible",_value)} tipo='LEJOS_OI' buttonText={<SelectCodeButton />} callback={(v)=>{on_change("lejos_oi",v)}}/>
                    </Col>
                </Row>
                <Row className="table-row-light"  style={{padding:".7em"}}>
        ...
        },
        {
            ...
            children: 
                ...
                <Row className="table-row-light" style={{padding:".7em"}}>
                    <Col style={_style_label} span={2}>OD</Col>
                    <Col span={22}>
                        <RecStockCristalEsfCil onVisibleChange={(_value)=>onVisibleChange("cerca_od_visible",_value)} tipo='CERCA_OD'  buttonText={<SelectCodeButton />} callback={(v)=>{on_change("cerca_od",v)}}/>
                ...
                <Row className="table-row-dark" style={{padding:".7em"}}>
                    <Col style={_style_label} span={2}>OI</Col>
                    <Col span={22}>
                        <RecStockCristalEsfCil onVisibleChange={(_value)=>onVisibleChange("cerca_oi_visible",_value)} tipo='CERCA_OI'  buttonText={<SelectCodeButton />} callback={(v)=>{on_change("cerca_oi",v)}}/>
...
export default RecetaStockItemsB;