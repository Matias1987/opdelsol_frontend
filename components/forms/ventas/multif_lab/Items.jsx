    ...
    <>
        ...
        <Col span={22}>
          <VentasArmazon
            onVisibleChange={(_value) =>
              onVisibleChange("armazon_visible", _value)
            }
            tipo="ARMAZON"
            buttonText={<SelectCodeButton />}
            callback={(v) => {
      ...
      <Row className="table-row-dark" style={{ padding: ".7em" }}>
        ...
        <Col span={22}>
          <VentasTratamiento
            onVisibleChange={(_value) =>
              onVisibleChange("tratamiento_visible", _value)
            }
            tipo="TRATAMIENTO"
            buttonText={<SelectCodeButton />}
            callback={(v) => {
              on_change("tratamiento", v);
            }}
            data={mlabitems.tratamiento}
          />
        </Col>
      </Row>
    </>
