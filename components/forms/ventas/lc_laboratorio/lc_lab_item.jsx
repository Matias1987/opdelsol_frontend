      ...
      <Row gutter={[16, 16]}>
        ...
        <Col>
          <Input
            ...
            value={LC.diametro}
            onChange={(e) => {
              on_change(e.target.value, "diametro");
            }}
          />
        </Col>
        <Col>
          <Input
            ...
            value={LC.precio_str}
            onChange={(v) => {
              on_precio_change(v.target.value);
            }}
          />
        </Col>
        <Col>
