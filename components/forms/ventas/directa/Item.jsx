...
const VDItem = (props) => {
    ...
    columns={[
        ...
        {title:"Precio", dataIndex:"precio", width:"160px", render:(_,{precio,codigo, precio_str})=><Input onClick={e=>{e.target.select()}} onWheel={(e)=>{e.target.blur()}} type="number" value={precio_str} onChange={(e)=>{
            setItems(__items=>
                {
