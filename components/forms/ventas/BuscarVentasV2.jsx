...
import { Button, Card, Checkbox, Col, Input, Modal, Row, Table, Tag } from "antd";
        ...
        return (
          <>
            <Button
              ...
              type="link"
              onClick={(_) => {
                on_venta_click(estado, id, en_deposito, idsucursal);
              }}
            >
              Ventas Ingresadas
            </Button>
        ...
        return (
          <>
            <ListaVentas
              ...
              cobrar
              accion="ingreso"
              titulo="Ventas Ingresadas"
              estado="INGRESADO"
              buttonText="Dar Ingreso"
            />
          </>
        );
      case "PENDIENTE":
        return selectedVenta.en_deposito != 0 ? (
          <>
            <ListaVentas
              ...
              accion="resfuerzo"
              en_laboratorio={1}
              titulo="Ventas Pendientes en Laboratorio"
              estado="PENDIENTE"
              buttonText="Resfuerzo Seña"
            />
          </>
        ) : (
          <>
        ...
        return (
          <>
            <ListaVentas
              ...
              cobrar
              accion="entrega"
              titulo="Ventas Terminadas"
              estado="TERMINADO"
              buttonText="Entrega o Resfuerzo"
            />
          </>
        );
      case "ENTREGADO":
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  render: (
                    _,
                    { idventa, estado, en_laboratorio, idsucursal }
                  ) => {
                    return (
                      <div
                        onClick={(e) => {
                        ...
                        <Button
                          ...
                          onClick={(_) => {
                            setSelectedVenta((_) => ({
                              estado: estado,
                              id: idventa,
                              en_deposito: en_laboratorio,
                              idsucursal: idsucursal,
                            }));
                            setModalImprimirOpen(true);
                          }}
                        >
                          <PrinterFilled size={"small"} />
                        </Button>
