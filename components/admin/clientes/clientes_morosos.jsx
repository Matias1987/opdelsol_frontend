...
const ClientesMorosos = (props) => {
  ...
  return (
    <>
      <Card
        title="Clientes Morosos Sin Bloquear (2 meses)"
      ...
      >
        <>
          <Row style={row_style}>
            ...
            <Col span={12}>
              <Checkbox
                value={ocultarMarcados}
                onChange={(e) => {
                  setOcultarMarcados(e.target.checked);
                }}
              >
                Ocultar marcados
              </Checkbox>
          ...
          <Row style={row_style}>
            <Col span={24}>
              <Table
                ...
                dataSource={
                  ocultarMarcados
                    ? dataSource.filter((c) => +c.checked != 1)
                    : dataSource
                }
                scroll={{ y: "600px" }}
              />
