...
const BuscarCodigoFactura = (props) => {
    ...
    return (
        ...
        <Row>
            ...
            { ((hideExtOpt||"0") ==="1") ? <></> : <Space direction="vertical" size="middle">
                    ...
                    columns={
                        [
                            ...
                            {title:"Descripcion", dataIndex: "descripcion",},
                            {
                                ...
                                dataIndex: "idcodigo",
                                render: 
                                    (_,_record)=><Button style={{color:"blue"}} onClick={()=>{props.callback(_record)}}><CheckCircleFilled /> Seleccionar</Button>
                            },
                        ]
                    }
                />
