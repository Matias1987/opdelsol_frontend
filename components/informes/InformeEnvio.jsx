  ...
  const contenido = () => {
    return (
      <div style={{ backgroundColor: "white" }}>
        {typeof props.exportEnabled === "undefined" ? (
          <></>
        ) : (
          <ExportToCSV
            parseFnt={() => {
              ...
              itemsContent.forEach((i) => {
                str += `"${i.codigo}",${i.cantidad},,,\r\n`;
              });
        ...
        <div style={{ padding: "4em" }}>
          <div style={{ textAlign: "center" }}>
            <h2 style={{ all: "initial" }}>
              <u>Resumen Env&iacute;o</u>
            </h2>
          </div>
          <table style={{ width: "100%" }}>
            <tbody>
              <tr>
                <td>
                  <h4>Optica Del Sol</h4>
                </td>
                <td>
                  Fecha: <b>{content.fecha}</b>
                </td>
              </tr>
              <tr>
                <td>
                  Nro. Envio: &nbsp; <b>{content.id}</b>
                </td>
                <td style={{ fontSize: "1.2em" }}>
                  Sucursal Destino: &nbsp; <b>{content.sucursal}</b>
                </td>
                <td style={{ fontSize: ".7em" }}>
                  Sucursal Origen: &nbsp; {content.sucursal_origen}
                </td>
              </tr>
              <tr>
                <td>
                  Cantidad: &nbsp; <b>{content.cantidad}</b>
                </td>
                <td></td>
              </tr>
            </tbody>
