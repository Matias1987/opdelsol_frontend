...
export default function InformeX(props) {
        ...
        <table style={{ width: "100%" }}>
          <tbody>
            <tr>
              <td>
                <div className="wrap-for-dotted-separated">
                  <span className="l-span-dotted-line">Efectivo:</span>
            ...
            <tr>
              <td>
                <div className="wrap-for-dotted-separated">
                  <span className="l-span-dotted-line">Cheque:</span>
                  <span className="r-span-dotted-line">
            ...
            <tr>
              <td>
                <div className="wrap-for-dotted-separated">
                  <span className="l-span-dotted-line">Tarjeta:</span>
                  <span className="r-span-dotted-line">
            ...
            <tr>
              <td>
                <div className="wrap-for-dotted-separated">
                  <span className="l-span-dotted-line">Mutual:</span>
                  <span className="r-span-dotted-line">
            ...
            <tr>
              <td>
                <div className="wrap-for-dotted-separated">
                  <span className="l-span-dotted-line">Mercado Pago:</span>
                  <span className="r-span-dotted-line">
            ...
            <tr>
              <td>
                <div className="wrap-for-dotted-separated">
                  <span className="l-span-dotted-line">Transferencia:</span>
                  <span className="r-span-dotted-line">
            ...
            <tr>
              <td>
                <div className="wrap-for-dotted-separated">
                  <span className="l-span-dotted-line">TOTAL:</span>
                  <span className="r-span-dotted-line">
  ...
  const data_cliente = () => {
    ...
    return dataCliente == null ? (
      ...
      <>
        Se&ntilde;or/es: {dataCliente.apellido + ", " + dataCliente.nombre}
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;D.N.I.:
  ...
  const html_cheque_tarjeta_mutual = () => {
    return modoPago == null ? (
      <Spin />
    ) : (
      <>
        {modoPago.cheque_monto == 0 ? (
          <></>
        ) : (
          <p>
            Cheque: {modoPago.cheque_nro} Banco: {modoPago.banco} &nbsp;
          </p>
        )}
        {modoPago.tarjeta_monto == 0 ? (
          <></>
        ) : (
          <p>
            Tarjeta: {modoPago.tarjeta_tarjeta} Cuotas:{" "}
            {
              modoPago.cant_cuotas1 /*Numero: {modoPago.tarjeta_nro} Cupon: {modoPago.tarjeta_cupon}*/
            }
          </p>
        )}
        {modoPago.tarjeta_tarjeta1 != 0 ? (
          <p>
            Tarjeta 2: {modoPago.tarjeta_tarjeta1} Cuotas:{" "}
            {modoPago.cant_cuotas2}
          </p>
        ) : (
          <></>
        )}
        {modoPago.mutual_monto == 0 ? (
          <></>
        ) : (
          <p>Obra Social: {modoPago.mutual_mutual} </p>
        )}
      </>
    );
  };
          ...
          <tbody>
                  ...
                  <tbody>
                    <tr>
                      <td style={{ width: "33%" }}>
                        <p>
                          Sucursal:{" "}
                          {dataSucursal == null ? "" : dataSucursal[0].nombre}{" "}
                          <br />
                          {data_cliente()}
                        </p>
                      </td>
                      ...
                      <td>
                        <p>
                          Nro Recibo: {dataPago.idcobro}
                          <br />
                          Fecha: {dataPago.fecha_formatted}
                          <br />
                          &nbsp;
                        </p>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <p>
                          Recibi la suma de:{" "}
                          <b>{convertToWords(dataPago.monto)}</b>
                          <br />
                          En concepto de: {dataPago.concepto_pago}
                          <br />
                          {/*"SALDO CTA CTE:  " + currency_format(dataPago.saldo_actual) */}
                        </p>
                        <hr />
                        {html_cheque_tarjeta_mutual()}
                      </td>
                      <td>{tabla_modo_pago()}</td>
                    </tr>
                  </tbody>
                </table>
              </td>
            ...
            <tr>
              <td>
                <p>
                  Operador:{" "}
                  <DetallesVendedor idusuario={dataPago.usuario_idusuario} />{" "}
                  &nbsp;Caja: {dataPago.caja_idcaja} Turno {"M"}
                </p>
                <br />
                <p>
                  Firma Cajero o Responsable: _______________________________
                </p>
              </td>
            </tr>
            <tr>
