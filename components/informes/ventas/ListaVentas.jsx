...
const ListaVentas = (props) => {
    ...
    const columns = [
        { width: "60px", hidden: false, title: "Nro.", dataIndex: "idventa", sorter: (a, b) => a.idventa -b.idventa },
        {
        ...
        { width: "180px", hidden: false, title: "Cliente", dataIndex: "cliente", sorter: (a, b) => a.cliente.localeCompare(b.cliente) },
        { width: "110px", hidden: false, title: "Vendedor", dataIndex: "vendedor", sorter: (a, b) => a.vendedor.localeCompare(b.vendedor) },
        {
