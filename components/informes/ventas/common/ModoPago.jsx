...
export default function ModoPagoInf(props){
    ...
    const get_mp = (r)=>{
        switch(r.modo_pago){
            ...
            case "ctacte": return   <tr><td><div className="wrap-for-dotted-separated"><span className="l-span-dotted-line">CTA. CTE.:</span><span className="r-span-dotted-line"> ${formatFloat(r.monto)}&nbsp;&nbsp;Cant. Cuotas:&nbsp;{r.cant_cuotas}&nbsp;&nbsp;Monto Cuota:&nbsp;${formatFloat(r.monto_cuota)}</span><hr /></div></td></tr>
