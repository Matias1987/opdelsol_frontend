          ...
          <tr>
            <td>
              <div className="wrap-for-dotted-separated">
                ...
                <span className="r-span-dotted-line">
                  {" "}
                  ${formatFloat(r.monto)}&nbsp;&nbsp;Tarjeta:&nbsp;
                  {r.nombre_tarjeta}
                </span>
                <span>
                    &nbsp;&nbsp;Nro. Cuotas:&nbsp;{r.cant_cuotas}
                </span>
                <hr />
              </div>
            </td>
      ...
      case "ctacte":
        return (
          <tr>
            <td>
              <div className="wrap-for-dotted-separated">
                <span className="l-span-dotted-line">CTA. CTE.:</span>
                <span className="r-span-dotted-line">
                  {" "}
                  ${formatFloat(r.monto)}&nbsp;&nbsp;Cant. Cuotas:&nbsp;
                  {r.cant_cuotas}&nbsp;&nbsp;Monto Cuota:&nbsp;$
                  {formatFloat(r.monto_cuota)}
                </span>
                <hr />
              </div>
            </td>
