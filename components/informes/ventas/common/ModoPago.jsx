...
export default function ModoPagoInf(props){
    ...
    const get_mp = (r)=>{
        switch(r.modo_pago){
            case "tarjeta": return  <tr><td><div className="wrap-for-dotted-separated"><span className="l-span-dotted-line">{r.modo_pago}:</span><span className="r-span-dotted-line"> ${currency_format(r.monto)}&nbsp;&nbsp;tarjeta:&nbsp;{ r.nombre_tarjeta}</span><hr /></div></td></tr>
            case "tarjeta1": return  <tr><td><div className="wrap-for-dotted-separated"><span className="l-span-dotted-line">{r.modo_pago}:</span><span className="r-span-dotted-line"> ${currency_format(r.monto)}&nbsp;&nbsp;tarjeta:&nbsp;{ r.nombre_tarjeta}</span><hr /></div></td></tr>
            case "ctacte": return   <tr><td><div className="wrap-for-dotted-separated"><span className="l-span-dotted-line">{r.modo_pago}:</span><span className="r-span-dotted-line"> ${currency_format(r.monto)}&nbsp;&nbsp;Cant. Cuotas:&nbsp;{r.cant_cuotas}&nbsp;&nbsp;Monto Cuota:&nbsp;${r.monto_cuota}</span><hr /></div></td></tr>
            case "cheque": return   <tr><td><div className="wrap-for-dotted-separated"><span className="l-span-dotted-line">{r.modo_pago}:</span><span className="r-span-dotted-line"> ${currency_format(r.monto)}&nbsp;&nbsp;Banco: &nbsp;{r.nombre_banco}</span><hr /></div></td></tr>
            case "mutual": return   <tr><td><div className="wrap-for-dotted-separated"><span className="l-span-dotted-line">{r.modo_pago}:</span><span className="r-span-dotted-line"> ${currency_format(r.monto)}</span><hr /></div></td></tr>
