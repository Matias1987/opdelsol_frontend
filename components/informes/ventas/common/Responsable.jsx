...
const ResponsableInf = (props) => {
    ...
    <p>
        ...
        <span style={{whiteSpace:"nowrap"}}>Nro. Cliente: <span style={{fontWeight:"bolder"}}>{props.id}</span>&nbsp;&nbsp;DNI:<span style={{fontWeight: 'bolder'}}><MostrarDNI dni={data.dni} /></span>Tel.:<span style={{fontWeight: 'bolder'}}>{data.telefono1}</span></span><br /> 
