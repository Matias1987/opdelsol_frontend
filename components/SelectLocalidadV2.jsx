...
const SelectLocalidadV2 = (props) => {
  ...
  const _localidades_ = (_) =>
    localidades == null ? (
      <>
        <i>Seleccione Provincia...</i>
      </>
    ) : (
      <>
        <select
          defaultValue={selectedLocalidad.idlocalidad}
          style={_select_style}
  ...
  return provincias == null ? (
    ...
    <>
      <Row>
        <Col span={3} style={{ textAlign: "right", paddingTop: ".5em" }}>
          Prov.:&nbsp;&nbsp;
        </Col>
        <Col span={8}>
          <select
            defaultValue={globals.obtenerOpticaProvincia()}
            style={_select_style}
