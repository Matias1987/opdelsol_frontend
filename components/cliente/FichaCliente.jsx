...
export default function FichaCliente(props) {
  ...
  const desBloquear = (_) => {
    ...
    fetch(get.desbloquear_cliente + dataCliente.idcliente)
      ...
      .catch(_=>{console.log("error fetching")});
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      align: "right",
      render: (_, { debe }) => (
        <>{formatFloat(parseFloat(debe || 0).toFixed(2))}</>
      ),
    },
    {
      width: "120px",
      ...
      align: "right",
      render: (_, { haber }) => (
        <>{formatFloat(parseFloat(haber || 0).toFixed(2))}</>
      ),
    },
    {
      width: "120px",
      ...
      dataIndex: "saldo",
      render: (_, { saldo }) => (
        <>{formatFloat(parseFloat(saldo || 0).toFixed(2))}</>
      ),
    },
  ];
                  ...
                  return (
                    <>
                      <Table.Summary.Row>
                        ...
                        <Table.Summary.Cell align="right">
                          <b>
                            {formatFloat((total_debe - total_haber).toFixed(2))}
                          </b>
                        </Table.Summary.Cell>
                      </Table.Summary.Row>
                    </>
