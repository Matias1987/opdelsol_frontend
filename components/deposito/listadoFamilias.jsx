      ...
      <Modal
        ...
        title={
          <i style={{ color: "#555555", fontSize: ".9em" }}>
            Editar Precios Tipo:&nbsp;<b>{"Familia"}</b>
            &nbsp;&nbsp;&nbsp;ID:&nbsp;<b>{selectedFamilia}</b>
          </i>
        }
